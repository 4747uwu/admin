...
import { createVipPlan, updateVipPlan, updateVipPlanBenefits } from "@/store/vipPlanSlice";
...
const VipPlanBenefitDialog = () => {
    ...
    const handleSubmit = (e: any) => {
        ...
        if (!audioCallDiscount ||
            ...
            if (!audioCallDiscount) error.audioCallDiscount = "Audio Call Discount is Required";
            if (audioCallDiscount <= 0) error.audioCallDiscount = "Audio Call Discount can not less than or equal to 0";
            if (audioCallDiscount > 100) error.audioCallDiscount = "Audio Call Discount can not greater than 100";


            if (!videoCallDiscount) error.videoCallDiscount = "Video Call Discount is Required";
            if (videoCallDiscount <= 0) error.videoCallDiscount = "Video Call Discount can not less than or equal to 0";
            if (videoCallDiscount > 100) error.videoCallDiscount = "Video Call Discount can not greater than 100";

            if (!randomMatchCallDiscount) error.randomMatchCallDiscount = "Random Match Call Discount is Required";
            if (randomMatchCallDiscount <= 0) error.randomMatchCallDiscount = "Random Match Call Discount can not less than or equal to 0";
            if (randomMatchCallDiscount > 100) error.randomMatchCallDiscount = "Random Match Call Discount can not greater than 100";

            if (!topUpCoinBonus) error.topUpCoinBonus = "Top Up Coin Bonus is Required";
                                ...
                                <div className="row align-items-start formBody">
                                    ...
                                    <div className="col-6">
                                        <ExInput
                                            ...
                                            errorMessage={error.audioCallDiscount && error.audioCallDiscount}
                                            onChange={(e: any) => {
                                                setAudioCallDiscount(e.target.value);
                                                if (!e.target.value) {
                                                    return setError({
                                                        ...error,
                                                        audioCallDiscount: "audioCallDiscount is Required !",
                                                    });
                                                } else if (e.target.value > 100 ){
                                                    return setError({
                                                        ...error,
                                                        audioCallDiscount: "Audio Call Discount can not greater than 100",
                                                    })
                                                } else if (e.target.value <= 0 ){
                                                    return setError({
                                                        ...error,
                                                        audioCallDiscount: "Audio Call Discount can not less than or equal to 0",
                                                    })
                                                }
                                                else {
                                                    setError({
                                    ...
                                    <div className="col-6">
                                        <ExInput
                                            ...
                                            errorMessage={error.videoCallDiscount && error.videoCallDiscount}
                                            onChange={(e: any) => {
                                                setVideoCallDiscount(e.target.value);
                                                if (!e.target.value) {
                                                    return setError({
                                                        ...error,
                                                        videoCallDiscount: "videoCallDiscount is Required !",
                                                    });
                                                }else if (e.target.value > 100 ){
                                                    return setError({
                                                        ...error,
                                                        videoCallDiscount: "Video Call Discount can not greater than 100",
                                                    })
                                                }  else if (e.target.value <= 0 ){
                                                    return setError({
                                                        ...error,
                                                        videoCallDiscount: "Video Call Discount can not less than or equal to 0",
                                                    })
                                                }
                                    ...
                                    <div className="col-6">
                                        <ExInput
                                            ...
                                            errorMessage={error.randomMatchCallDiscount && error.randomMatchCallDiscount}
                                            onChange={(e: any) => {
                                                setRandomMatchCallDiscount(e.target.value);
                                                if (!e.target.value) {
                                                    return setError({
                                                        ...error,
                                                        randomMatchCallDiscount: "Random Match Call Discount is Required !",
                                                    });
                                                } 
                                                else if (e.target.value > 100 ){
                                                    return setError({
                                                        ...error,
                                                        randomMatchCallDiscount: "Random Match Call Discount can not greater than 100",
                                                    })
                                                } else if (e.target.value <= 0 ){
                                                    return setError({
                                                        ...error,
                                                        randomMatchCallDiscount: "Random Match Call Discount can not less than or equal to 0",
                                                    })
                                                }
                                                else {
                                                    setError({
                                    ...
                                    <div className="col-6">
                                        <ExInput
                                            ...
                                            errorMessage={error.topUpCoinBonus && error.topUpCoinBonus}
                                            onChange={(e: any) => {
