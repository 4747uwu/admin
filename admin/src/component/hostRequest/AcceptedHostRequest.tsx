    ...
    const acceptedHostRequestTable = [
                ...
                return (
                    <div className="d-flex justify-content-end align-items-center fw-normal">
                        ...
                        <div style={{ width: "200px", textAlign: "start" }}>
                            <p className="text-capitalize text-nowrap">{row?.agencyId?.name ? row?.agencyId?.name : row?.agency?.name || "-"}</p>
...

        {
            ...
            Cell: ({ row }: { row: any }) => { // Correct destructuring
                ...
                return (
                    <div className="d-flex justify-content-end align-items-center fw-normal cursor-pointer"
                        onClick={handleClick}
                    >
                        {/* Image Section */}
...

        {
            ...
            Cell: ({ row, index }: { row: any, index: any }) => {
                ...
                return (
                    <div className="text-capitalize padding-left-2px fw-normal"
                        style={{ width: "250px" }}
                    >
