...
useEffect(() => {
...

        {
            ...
            Cell: ({ row }: { row: any }) => (
                ...
                <span className="d-flex justify-content-center">
                    <button
                        className="me-2"
                        style={{ backgroundColor: "#CDE7FF", borderRadius: "8px", padding: "8px" }}
    ...
    return (
        <div className="mainCategory">
            ...
            {dialogueType == "assignagency" && <AssignAgencyToDialog selectedAgency={selectedAgency} setSelectedAgency={setSelectedAgency} />}
            <CommonDialog
                open={showDialog}
