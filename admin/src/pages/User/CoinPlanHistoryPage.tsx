        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <div>
                        <button className={type === "coin_plan_purchase" ? "active-purchase-coinPlan" : "purchasecoinplan"}
                    ...
                    <div >
                        <button className={type === "vip_plan_purchase" ? "status-active-purchasevipplan" : "purchasevipplan"}
