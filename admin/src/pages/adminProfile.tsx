      ...
      <div className="mainAdminProfile">
        ...
        <div className="d-lg-flex d-md-block">
          <div className="col-12 col-sm-12  col-lg-3 col-md-5 mt-4">
            ...
            <div className="card" style={{ minHeight: "575px", maxWidth: "350px", borderRadius: "20px", padding: "24px 24px 0px 24px" }}>
              {
                roleSkeleton ?
                  <>
                    <div
                  ...
                  <div className="card-body">
                    <div className="position-relative">
                      ...
                      />
                      <img
                        src={updatedImagePath ?imagePath : male.src}
                        width={300}
                        height={354}
                        alt="admin"
                    ...
                    <div style={{ marginTop: "28px", textAlign: "center", }}>
                      <h6 style={{ fontSize: "24px" }}>{admin?.name}</h6>
                      <p style={{ color: "#666666", fontSize: "18px" }}>{admin?.email}</p>
                    </div>
          ...
          <div className="col-12 col-sm-12 col-md-12 col-lg-9 col-xxl-9 mt-4 pl-0">
            <div className="row">
              ...
              >
                <div className="card marginleft" style={{ height: 573, paddingTop: "10px", paddingLeft: "20px", borderRadius: "20px" }}>
                  {type === "change_password" ? (
                    <div className="card-body">
                      <div
                        className="my-2 profile_width"

                      >
                        <button
                          type="button"
                          className={`${type === "edit_profile" ? "activeBtn" : "disabledBtn"}`}
                        ...
                        <button
                          type="button"
                          className={`${type === "change_password" ? "activeBtn" : "disabledBtn"
                            } ms-1`}
                        ...
                        roleSkeleton ?
                          <div className="col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7">
                            ...
                            >
                              ...
                              {/* Input Fields */}
                              {["Old Password", "New Password", "Confirm Password"].map((_, i) => (
                                <div key={i} className="mb-4">
                                  <div
                                    className="skeleton mb-3"
                                    style={{ height: "16px", width: "200px", borderRadius: "4px" }}
                                  ></div>
                                  <div
                                    className="skeleton"
                                    style={{
                          ...
                          <div className="col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7">
                            ...
                            >
                              <Button
                                ...
                                style={{ backgroundColor: "#1ebc1e", marginTop: "80px", width: "148px" }}
                              />
                            </div>
                          </div>
                      }
                            ...
                            <div className="col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7 my-5">
                              ...
                              >
                                <Button
                                  ...
                                  text={`Submit`}
                                  className={` text-white`}
                                  style={{ backgroundColor: "#1ebc1e", width: "148px", marginTop: "185px" }}
                                />
                              </div>
                            </div>
